...
class ApartmentProgressBar extends React.Component {
    ...
    render() {
        return <div className="flex-nowrap d-flex mb-5">
            <ApartmentSnippet icon="fas fa-door-open p-2" title="Welcome" position="start" active={this.state.active}
                              history={this.props.history} path="/apartment/welcome" onclick={this.onclick}/>
            <ApartmentSnippet icon="far fa-clipboard p-2" title="Details" active={this.state.active}
            ...
            <ApartmentSnippet icon="far fa-flag p-2" title="Finish" active={this.state.active}
                              history={this.props.history} path="/apartment/finish" onclick={this.onclick}/>
        </div>
