...
import {removeRule} from "../actions/registrationFlat/registrationFlatActions";
    ...
    render() {
        return <div className="mt-2 mr-3 mb-4 p-4 border-bottom">
            <div className="row">
                ...
                <div className="text-right text-info col-3" onClick={()=>STORE.dispatch(removeRule(this.props.text))}>remove</div>
            </div>
        </div>
    }
}
